...
public class DoseDeVaccinSteps {
	...
	public void je_verifie_que_le_nombre_de_doses_de_vaccin_injectees_correspond_bien_au_pour_le_vaccin_contre_la_Covid(
			Integer int1) {
		assertTrue(int1 == DoseDeVaccinFactory.produirVaccin(typeVaccin.COVID).getNbDosesShemaVaccinalComplet());
	}
	...
	public void je_verifie_que_le_nombre_de_doses_de_vaccin_injectees_correspond_bien_au_pour_le_vaccin_contre_la_Papillomavirus(
			Integer int1) {
		assertTrue(DoseDeVaccinFactory.produirVaccin(typeVaccin.PAPILLOMAVIRUS).getNbDosesShemaVaccinalComplet() == int1);
	}
	...
	public void je_verifie_que_le_nombre_de_doses_de_vaccin_injectees_correspond_bien_au_pour_le_vaccin_contre_la_Fievre_jaune(
			Integer int1) {
		// Write code here that turns the phrase above into concrete actions
		assertTrue(DoseDeVaccinFactory.produirVaccin(typeVaccin.FIEVRE_JAUNE).getNbDosesShemaVaccinalComplet() == int1);
	}
